...
export default function AdminLayout({ children }) {
  ...
  const menuGroups = [
    ...
    },
    {
      ...
      children: [
        ...
        { id: "siswa", label: "Data Siswa", icon: Users, path: "/admin/siswa" },
        { id: "jurusan", label: "Data Jurusan", icon: BookOpen, path: "/admin/jurusan" },
        { id: "kriteria", label: "Data Kriteria", icon: Settings, path: "/admin/kriteria" },
      ],
    },
    {
      id: "survei",
      ...
      icon: ClipboardList,
      children: [
        { id: "survei-bakat", label: "Survei Bakat", icon: Award, path: "/admin/survei-bakat" },
        { id: "survei-minat", label: "Survei Minat", icon: Award, path: "/admin/survei-minat" },
      ],
    },
    {
      id: "penilaian",
      ...
      icon: PieChart,
      children: [
        { id: "nilai", label: "Nilai Rapor", icon: FileText, path: "/admin/nilai-rapor" },
        { id: "saw-process", label: "Proses SAW", icon: TrendingUp, path: "/admin/saw-process" },
        { id: "laporan", label: "Laporan Hasil", icon: FileText, path: "/admin/laporan" },
      ],
    },
  ...
  useEffect(() => {
    ...
    if (user.role !== "admin") {
      if (user.role === "guru_bk") navigate("/gurubk");
